...
const ProductInfo = () => {
  ...
  return (
    <section className={`flex flex-col h-full ${tajawal.className} text-right text-slate-900`} dir="rtl">
      ...
      <section className="pt-24 pb-6 mr-5 ml-4 px-4 sm:px-6">
      ...
      <section className="pb-12 mr-5 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            {/* RIGHT SIDE: Images */}
            <div className="order-1 ml-5 flex flex-col gap-6">
                ...
                <div className="flex items-center justify-center gap-2 md:gap-4">
                  ...
                  <div className="flex gap-2 overflow-x-auto py-2 px-1 scrollbar-hide">
                    <img
                      src={images[0]}
                      alt="Main Thumbnail"
                      className={`w-14 h-14 md:w-16 md:h-16 object-cover rounded-lg cursor-pointer border-2 transition-all shrink-0 ${currentGalleryIndex === 0 ? 'border-orange-500 scale-105 shadow-md' : 'border-transparent opacity-70 hover:opacity-100'}`}
                    ...
                    {galleryImages.map((img, index) => (
                      <img
                        ...
                        className={`w-14 h-14 md:w-16 md:h-16 object-cover rounded-lg cursor-pointer border-2 transition-all shrink-0 ${currentGalleryIndex === index + 1 ? 'border-orange-500 scale-105 shadow-md' : 'border-transparent opacity-70 hover:opacity-100'}`}
            ...
            {/* LEFT SIDE: THE FORM */}
            <div id="checkout-form" className="order-2 ml-5 bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden sticky top-24">
              <div className="bg-orange-600 text-black p-6 text-center relative overflow-hidden">
      ...
      <section className="py-16 ml-5 px-4 mr-5 bg-white border-t border-slate-100">
      ...
      {/* --- SCENARIOS SECTION --- */}
      <section className="py-16 px-4 ml-5 bg-slate-900 mr-5 rounded-3xl text-white relative overflow-hidden">
      ...
      <section className="py-16 px-4 mr-4 ml-5 bg-slate-50">
      ...
      {/* --- STICKY CTA BUTTON --- */}
      <div className="fixed bottom-0 left-0 w-full p-4 bg-white/80 backdrop-blur-md rounded-t-3xl border-t border-slate-200 z-50 flex justify-center shadow-[0_-10px_30px_rgba(0,0,0,0.05)] -right-5 lg:right-0">
        <button
